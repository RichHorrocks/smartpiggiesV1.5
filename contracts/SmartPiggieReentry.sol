...
*/
contract SmartPiggiesReentry is UsingConstants {
  using SafeMath for uint256;
  ...
  */
  struct DetailAuction {
    ...
    uint8 rfpNonce;
    bool[4] flags; // flags[3] mutex guard to disallow ending an auction if a transaction to satisfy is in progress
  }
